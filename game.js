...
function addItems() {
  ...
  createItem(450, 505, "coin");
  createItem(150, 505, "coin");
  createItem(300, 355, "coin");
  createItem(150, 205, "coin");

  createItem(300, 80, "coin");
  createItem(650, 80, "coin");
  createItem(50, 80, "coin");
  createItem(50, 355, "coin");
}
